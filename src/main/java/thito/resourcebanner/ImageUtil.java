...
public class ImageUtil {
	...
	public static final Color[] COLORS = { new Color(178, 179, 253), new Color(166, 243, 157),
			new Color(248, 130, 129) };
	public static final FileFilter IMAGES;
	public static final Random random = new Random();

	static {
		IMAGES = file -> file != null && (file.getName().endsWith(".png") || file.getName().endsWith(".jpg")
				|| file.getName().endsWith(".jpeg") || file.getName().endsWith(".gif")
				|| file.getName().endsWith(".bmp") || file.getName().endsWith(".webm"));
	}
	...
	public static void main(String[] args) {
		final JFrame frame = new JFrame("Color Picker :P");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		final JButton butt = new JButton("i love it");
		final JButton next = new JButton("meh, NEXT!");
		final JPanel shower = new JPanel();
