...
public class Marquee {
	...
	public static void main0(String[] args) {
		final Marquee mar = new Marquee("i want &asomething &rjust like this".replace('&', COLOR_CHAR),
				50);
		for (int i = 0; i < mar.chars.length;i ++) {
	...
	public static void main(String[] args) {
		final Marquee mar = new Marquee("i want &asomething &rjust like this".replace('&', COLOR_CHAR),
				200);
		JLabel label = new JLabel(mar.next());
		new Thread() {
			public void run() {
